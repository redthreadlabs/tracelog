...
const CONFIG_SCHEMA = [
  ...
  },
  {
    ...
    configType: 'byte',
    defaultValue: '768kb',
    envVar: 'TRACELOG_API_REQUEST_SIZE',
  },
  {
    name: 'apiRequestTime',
    configType: 'durationSeconds',
    defaultValue: '10s',
    envVar: 'TRACELOG_API_REQUEST_TIME',
  },
  {
  ...
  },
  {
    ...
    configType: 'boolean',
    defaultValue: true,
    envVar: 'TRACELOG_CENTRAL_CONFIG',
  },
  {
    name: 'cloudProvider',
  ...
  },
  {
    ...
    defaultValue: 1024,
    envVar: 'TRACELOG_MAX_QUEUE_SIZE',
  },
  {
  ...
  },
  {
    ...
    configType: 'boolean',
    defaultValue: false,
    envVar: 'TRACELOG_OPENTELEMETRY_BRIDGE_ENABLED',
  },
  {
  ...
  },
  {
    ...
    configType: 'durationSeconds',
    defaultValue: '30s',
    envVar: 'TRACELOG_SERVER_TIMEOUT',
  },
  {
    name: 'serverUrl',
    configType: 'url',
    defaultValue: 'http://127.0.0.1:8200',
    envVar: 'TRACELOG_SERVER_URL',
  ...
  },
  {
    ...
    configType: 'boolean',
    defaultValue: false,
    envVar: 'TRACELOG_USE_ELASTIC_TRACEPARENT_HEADER',
  },
  {
  ...
  },
  {
    ...
    configType: 'boolean',
    defaultValue: true,
    envVar: 'TRACELOG_VERIFY_SERVER_CERT',
  },
  {
    name: 'errorMessageMaxLength',
    configType: 'byte',
    defaultValue: undefined,
    envVar: 'TRACELOG_ERROR_MESSAGE_MAX_LENGTH',
  ...
  },
  {
    ...
    configType: 'boolean',
    defaultValue: undefined,
    envVar: 'TRACELOG_CAPTURE_SPAN_STACK_TRACES',
  ...
  },
  {
    ...
    configType: 'string',
    defaultValue: undefined,
    envVar: 'TRACELOG_PAYLOAD_LOG_FILE',
  },
  {
    name: 'serverCaCertFile',
    configType: 'string',
    defaultValue: undefined,
    envVar: 'TRACELOG_SERVER_CA_CERT_FILE',
  },
  {
    name: 'secretToken',
    configType: 'string',
    defaultValue: undefined,
    envVar: 'TRACELOG_SECRET_TOKEN',
  ...
  },
  {
    ...
    defaultValue: undefined,
    envVar: 'TRACELOG_SPAN_FRAMES_MIN_DURATION',
    deprecated: 'Deprecated in: v3.30.0, use spanStackTraceMinDuration',
  },
  ...
  },
  {
    ...
    configType: 'stringKeyValuePairs',
    defaultValue: undefined,
    envVar: 'TRACELOG_APM_CLIENT_HEADERS',
  },
